...
welcome_msg="""در حال ارسال پیام ناشناس به Bahar هستی.
...
def handle_text(message):
    try:
        ...
        if message.text in  filter_msgs:
            ...
            bot.send_message(id_bahar, f'Message from @{user_name} ({user_id}): {content}', reply_markup=create_markup(user_id, message.message_id))
...
def handle_photo(message):
    try:
        ...
        bot.reply_to(message, message_to_user)
        bot.send_photo(id_bahar, file_id, caption=f'Message from @{user_name} ({user_id}): {content}', reply_markup=create_markup(user_id, message.message_id))
...
def handle_video(message):
    try:
        ...
        bot.reply_to(message, message_to_user)
        bot.send_video(id_bahar, file_id, caption=f'Message from @{user_name} ({user_id}): {content}', reply_markup=create_markup(user_id, message.message_id))
...
def handle_voice(message):
    try:
        ...
        bot.reply_to(message, message_to_user)
        bot.send_voice(id_bahar, file_id, caption=f'Message from @{user_name} ({user_id}): Voice Message', reply_markup=create_markup(user_id, message.message_id))
...
def handle_document(message):
    try:
        ...
        bot.reply_to(message, message_to_user)
        bot.send_document(id_bahar, file_id, caption=f'Message from @{user_name} ({user_id}): {content}', reply_markup=create_markup(user_id, message.message_id))
...
def handle_audio(message):
    try:
        ...
        bot.reply_to(message, message_to_user)
        bot.send_audio(id_bahar, file_id, caption=f'Message from @{user_name} ({user_id}): {content}', reply_markup=create_markup(user_id, message.message_id))
...
def handle_callback(call):
    try:
        ...
        if action == 'respond':
            ...
            bot.send_message(id_bahar, f'Message from {user_id} was deleted.')
    except Exception as e:
...
def process_response(message, user_id):
    try:
        ...
        bot.send_message(id_bahar, f'Response sent to {user_id}.')
